export const en = {
  ...
  season: {
    ...
    noHistory: 'No past seasons yet.',
    rank: '#{{rank}}',
    scoreLabel: '{{score}} pts',
    gamesPlayed: '{{count}} game',
    gamesPlayed_plural: '{{count}} games',
    tierGold: 'Gold',
    tierSilver: 'Silver',
    tierBronze: 'Bronze',
    tierIron: 'Iron',
    rewardTitle: 'Rank Reward',
    thresholdGold: '≥ {{score}} pts',
    thresholdSilver: '≥ {{score}} pts',
    thresholdBronze: '≥ {{score}} pts',
    thresholdIron: '< {{score}} pts',
    emptyLeaderboard: 'No entries yet. Play a game to appear on the leaderboard!',
    archivedSeason: 'Season {{name}}',
