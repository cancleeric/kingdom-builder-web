export const en = {
  ...
  locationDescription: {
    ...
    Farm: 'Place 1 extra settlement on a Grass cell (adjacent to your settlements if possible).',
    Harbor: 'Place 1 extra settlement on any empty buildable cell adjacent to Water.',
    Oasis: 'Place 1 extra settlement on a Desert cell (adjacent to your settlements if possible).',
    Tower: 'Place 1 extra settlement on a board-edge cell (adjacent to your settlements if possible).',
    ...
    Oracle: 'Place 1 extra settlement on the terrain shown on your terrain card (adjacent to your settlements if possible).',
    Tavern: 'Place 1 extra settlement at the end of a horizontal row of at least 3 of your settlements.',
  },
  tooltip: {
  ...
  objectiveDescription: {
    ...
    Discoverers: 'Score 1 point for each horizontal row (r value) that contains at least one of your settlements.',
    ...
    Workers: 'Each settlement adjacent to a Location tile hex (including Castle) scores 1 point.',
  },
  objectiveCard: {
