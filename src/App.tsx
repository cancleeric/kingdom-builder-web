  ...
  return (
    <div className="w-screen h-screen flex flex-col bg-gray-50">
      ...
      <header className="bg-blue-600 text-white p-4 shadow-lg flex items-center justify-between">
        <h1 className="text-3xl font-bold text-center flex-1">Kingdom Builder</h1>
        <button
          id="tutorial-round-display"
          onClick={startTutorial}
          className="text-sm bg-white text-blue-600 font-semibold px-3 py-1 rounded hover:bg-blue-50 transition"
        >
          📖 教學
        </button>
      </header>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Game Board */}
        <div id="tutorial-board" className="flex-1 relative">
          {players.length > 0 && (
            <HexGrid
              board={board}
              validPlacements={
        ...
        <aside className="w-80 bg-white shadow-lg p-6 overflow-y-auto">
          ...
          {/* Terrain Card */}
          {currentTerrainCard && (
            <div id="tutorial-hand" className="mb-4">
          ...
          {objectiveCards.length > 0 && (
            <div id="tutorial-scoring-cards" className="mb-4">
          ...
          {currentPlayer && currentPlayer.tiles.length > 0 && (
            <div id="tutorial-location-tiles" className="mb-4">
      ...
      {/* Tutorial overlay — rendered on top of the game */}
