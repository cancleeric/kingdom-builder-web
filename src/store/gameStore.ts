...
import { createRandomBoard } from '../core/quadrant';
import type { TerrainCard } from '../core/terrain';
import { createTerrainDeck, shuffleDeck, drawCard } from '../core/terrain';
...
export const useGameStore = create<GameState>((set, get) => ({
  // Initial state — board is randomly generated on each page load
